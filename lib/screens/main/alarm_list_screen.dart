...
import 'package:alarm_app/widgets/alarm_item/alarm_item.dart';
import 'package:alarm_app/screens/edit_alarm/edit_alarm.dart';
import 'package:alarm_app/services/alarm_list_manager.dart';
import 'package:alarm_app/services/alarm_scheduler.dart';
import 'package:alarm_app/stores/alarm_list/alarm_list.dart';
import 'package:alarm_app/stores/observable_alarm/observable_alarm.dart';

class AlarmListScreen extends StatelessWidget {
  final AlarmList alarms;

  const AlarmListScreen({Key key,  this.alarms}) : super(key: key);
